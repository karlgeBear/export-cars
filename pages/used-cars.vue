<template>
  <div class="used-cars">
    ...
    <div class="container">
      <p>Final Page</p>
      <ul>
        <li><NuxtLink to="/used-cars/">Go to /used-cars</NuxtLink></li>
        <li><NuxtLink to="/used-cars/index">Go to /used-cars/index</NuxtLink></li>
        <li><NuxtLink to="/used-cars/make1/">Go to /used-cars/make1/</NuxtLink></li>
        <li><NuxtLink to="/used-cars/make2">Go to /child2</NuxtLink></li>
        <li><NuxtLink to="/used-cars/make/model">Go to /make/model</NuxtLink></li>
      </ul>
        <hr>
      <div class="box">
          <p>嵌套子页面内容区</p>
...
export default {
  ...
  beforeRouteUpdate (to, from, next) {
    ...
    if(to.name == 'used-cars'){
      this.make = ''
      this.model = ''
    }else if(to.name == 'used-cars-make'){
  ...
  methods: {
    getSelectVal(value){
      ...
      this.$router.push(`/used-cars${this.getQueryUrl}`)
      // this.$router.push({path: '/used-cars/',query:param})
    },
    clearModel(){
      this.model = ''
    },
