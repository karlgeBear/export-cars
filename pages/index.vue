        ...
        <CommonSearchBg>
          ...
          <div slot="type" class="type-box">
              <div class="type">
                <div class="type-icon">
                  <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" id="Group_557" data-name="Group 557" width="50" height="64.102" viewBox="0 0 164.104 64.102">
                      ...
                      <path id="Path_268" data-name="Path 268" d="M13596.227-20971.381l46.691,32.488-51.559.025Z" transform="translate(-13541.95 20991.875)" fill="#f1efef"></path>
                    </svg>
                  </a>
                </div>
                <div class="type-text"><a href="#">Sedan</a></div>
              </div>
              <div class="type">
                <div class="type-icon">
                  <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="58.459" viewBox="0 0 163.558 58.459">
                      <g id="Group_559" data-name="Group 559" transform="translate(0.002 -0.002)">
                        <path id="Path_240" data-name="Path 240" d="M14682.666-17675.51c6.831-.441,3.493-2,4.658-4.357s6.83-3.8,0-5.064-20.491-1.707-27.321,0-5.665,4.475,0,6.832S14675.836-17675.068,14682.666-17675.51Z" transform="translate(-14527.08 17699.047)" fill="#fff"></path>
                        <path id="Subtraction_37" data-name="Subtraction 37" d="M-14351,20677.193c-4.549,0-10.068-.318-10.531-1.832-.166-.545.341-1.217,1.506-2-1-4.67.082-10.6,2.963-16.275a31.61,31.61,0,0,1,4.858-7.084,19.218,19.218,0,0,1,6.015-4.553c2.4-1.07,6.081-1.248,9.639-1.422h.021l.221-.012c.041,0,.081,0,.121-.006l.457-.023.449-.023c.063,0,.123,0,.181-.008l.222-.01c2.574-.145,5.389-.219,8.366-.219,4.87,0,8.565.2,8.971.217.016,0,.023,0,.023,0a49.835,49.835,0,0,1,8.942-8.25,46.131,46.131,0,0,1,10.239-5.662,36.257,36.257,0,0,1,13.245-2.574h1.987c18.48,0,41.806,6.238,58.118,11.471,13.4,4.3,22.219,7.941,22.265,8.033,1.4.955,2.458,2.762,3.146,5.367a34.248,34.248,0,0,1,.944,7.867,80.532,80.532,0,0,1-.675,11.512l-.011.072,0,.01,0,.021a.227.227,0,0,0,0,.031v.012a10.27,10.27,0,0,1-8.112,4.3,7.186,7.186,0,0,1-1.022-.066l-13.479.248a8.889,8.889,0,0,0,1.816-5.418,9.014,9.014,0,0,0-9-9,9.012,9.012,0,0,0-9,9,9.007,9.007,0,0,0,2.02,5.678l-13.386.244v.037h-52.056v-.006h-14.706a9.3,9.3,0,0,0,2.125-5.953,8.771,8.771,0,0,0-8.5-9,8.773,8.773,0,0,0-8.5,9,9.29,9.29,0,0,0,2.126,5.953h-13.165v.006a.117.117,0,0,1-.036,0C-14345.3,20677.084-14348.42,20677.193-14351,20677.193Zm68.726-44.031a51.983,51.983,0,0,0-11.112,1.063c-3.456.809-7.623,3.857-10.51,6.271-3.077,2.586-5.472,5.09-5.48,5.1h38.489s0-.039,0-.115a111.559,111.559,0,0,0,0-11.256A54.193,54.193,0,0,0-14282.279,20633.162Zm18,2.1h0v10.322h18.97l-.006,0a15.92,15.92,0,0,0-6.5-6.5C-14256.434,20636.564-14264.2,20635.27-14264.275,20635.264Z" transform="translate(14361.565 -20627.461)" fill="#fff"></path>
                        <path id="Path_270" data-name="Path 270" d="M13596.071-20971.381l45.2,31.449-49.911.025Z" transform="translate(-13543.885 20989.234)" fill="#f1efef"></path>
                        <path id="Subtraction_36" data-name="Subtraction 36" d="M-14346.568,20657.461a14.9,14.9,0,0,1-10.605-4.393,14.9,14.9,0,0,1-4.393-10.605,14.9,14.9,0,0,1,4.393-10.607,14.9,14.9,0,0,1,10.605-4.4,14.9,14.9,0,0,1,10.605,4.4,14.9,14.9,0,0,1,4.393,10.607,14.9,14.9,0,0,1-4.393,10.605A14.9,14.9,0,0,1-14346.568,20657.461Zm0-24a9.01,9.01,0,0,0-9,9,9.01,9.01,0,0,0,9,9,9.01,9.01,0,0,0,9-9A9.01,9.01,0,0,0-14346.568,20633.463Z" transform="translate(14479 -20599)" fill="#fff"></path>
                        <path id="Subtraction_38" data-name="Subtraction 38" d="M-14346.568,20657.461a14.9,14.9,0,0,1-10.605-4.393,14.9,14.9,0,0,1-4.393-10.605,14.9,14.9,0,0,1,4.393-10.607,14.9,14.9,0,0,1,10.605-4.4,14.9,14.9,0,0,1,10.605,4.4,14.9,14.9,0,0,1,4.393,10.607,14.9,14.9,0,0,1-4.393,10.605A14.9,14.9,0,0,1-14346.568,20657.461Zm0-24a9.01,9.01,0,0,0-9,9,9.01,9.01,0,0,0,9,9,9.01,9.01,0,0,0,9-9A9.01,9.01,0,0,0-14346.568,20633.463Z" transform="translate(14385 -20599)" fill="#fff"></path>
                        <path id="Path_234" data-name="Path 234" d="M14672.021-17633.193h-4.091s-1.186,4.4,2.152,6.127h2.729a12.841,12.841,0,0,0,.188-3.463A6.689,6.689,0,0,0,14672.021-17633.193Z" transform="translate(-14512.557 17655.711)" fill="#ff4605"></path>
                        <path id="Path_235" data-name="Path 235" d="M14925.816-17637.883a3.027,3.027,0,0,0-.832.637c-.32.391-.746.926-.746.926h6.58l.775-1.562S14928.518-17639.443,14925.816-17637.883Z" transform="translate(-14911.271 17658.619)" fill="#fff"></path>
                        <path id="Path_236" data-name="Path 236" d="M0,5.691a26.481,26.481,0,0,0,5.8-.1A3.041,3.041,0,0,0,8.255,4.01C9.178,2.59,10.661,0,10.661,0L2.633.14Z" transform="matrix(-1, -0.017, 0.017, -1, 18.502, 29.281)" fill="#ff4605"></path>
                      </g>
                    </svg>
                  </a>
                </div>
                <div class="type-text"><a href="#">Coupe</a></div>
              </div>
              <div class="type">
                <div class="type-icon">
                  <a href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="64.414" viewBox="0 0 148.092 64.414">
                      <g id="Group_562" data-name="Group 562" transform="translate(-15054.172 20866.895)">
                        <path id="Subtraction_23" data-name="Subtraction 23" d="M13,26A13,13,0,0,1,7.94,1.022,13,13,0,0,1,18.06,24.978,12.919,12.919,0,0,1,13,26ZM13,5.4A7.6,7.6,0,1,0,20.6,13,7.612,7.612,0,0,0,13,5.4Z" transform="translate(15068 -20828.48)" fill="#fff"></path>
                        <path id="Subtraction_22" data-name="Subtraction 22" d="M13,26A13,13,0,0,1,7.94,1.022,13,13,0,0,1,18.06,24.978,12.919,12.919,0,0,1,13,26ZM13,5.4A7.6,7.6,0,1,0,20.6,13,7.612,7.612,0,0,0,13,5.4Z" transform="translate(15158 -20828.48)" fill="#fff"></path>
        ...
        <div class="featured-footer">
          <div class="follow-us">
            ...
            <div class="follow-us-icons">
              <a href="#" class="follow-us-icon"><i class="fab fa-facebook-f"></i></a>
              <a href="#" class="follow-us-icon"><i class="fab fa-twitter"></i></a>
              <a href="#" class="follow-us-icon"><i class="fab fa-instagram"></i></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="popular-makes-tabs">
          <div class="popular-makes-tab-title">
            <h1 class="title">Popular Makes</h1>
          </div>
          <div class="popular-makes-tab-btns">
            <div class="popular-makes-tab-btn">
              <div class="popular-makes-tab-btn__title">Audi</div>
              <div class="popular-makes-tab-btn__subtitle" id="subtitle">
                4 Listings
              </div>
            </div>
            <div class="popular-makes-tab-btn">
              <div class="popular-makes-tab-btn__title">BMW</div>
              <div class="popular-makes-tab-btn__subtitle">1 Listings</div>
            </div>
            <div class="popular-makes-tab-btn">
              <div class="popular-makes-tab-btn__title">Cadillac</div>
              <div class="popular-makes-tab-btn__subtitle">0 Listings</div>
            </div>
            <div class="popular-makes-tab-btn">
              <div class="popular-makes-tab-btn__title">Ferrari</div>
              <div class="popular-makes-tab-btn__subtitle">1 Listings</div>
            </div>
          </div>
        </div>
        <div class="popular-makes-car-list">
          <div class="featured-item">
            <div class="item-img">
              <a href="#">
                <div class="single-car-img">
      ...
      <div class="container">
        ...
        <div class="because-our-info">
          <div class="because-item">
            <div class="because-item-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="34" viewBox="0 0 24 34">
                <g id="medal" transform="translate(-71.962)">
                  <path id="Path_20" data-name="Path 20" d="M89.3,23.828l1.527-2.523,2.755-.957.305-2.947,2.073-2.078-.985-2.789.985-2.79L93.889,7.666l-.305-2.947-2.755-.957L89.3,1.239l-2.888.355L83.962,0,81.509,1.594l-2.887-.355L77.1,3.762l-2.755.957-.305,2.947L71.962,9.744l.985,2.79-.985,2.79L74.035,17.4l.305,2.947,2.755.957,1.527,2.523,2.888-.355,2.453,1.594,2.453-1.594ZM75.523,12.534a8.441,8.441,0,1,1,16.879,0,8.441,8.441,0,1,1-16.879,0Z" transform="translate(0 0)" fill="#ff4605"></path>
                  <path id="Path_21" data-name="Path 21" d="M163.072,89.333a6.6,6.6,0,1,0,6.482,6.6A6.55,6.55,0,0,0,163.072,89.333Z" transform="translate(-79.11 -83.401)" fill="#ff4605"></path>
                  <path id="Path_22" data-name="Path 22" d="M89.039,345.326l-3.435.422-1.815-3-.617-.214-2.661,8.471,4.791-.268,3.748,3.051,2.206-7.021Z" transform="translate(-7.992 -319.789)" fill="#ff4605"></path>
                  <path id="Path_23" data-name="Path 23" d="M274.168,342.749l-1.815,3-3.435-.422-2.217,1.441,2.206,7.021,3.748-3.051,4.791.268-2.661-8.471Z" transform="translate(-182.041 -319.789)" fill="#ff4605"></path>
                </g>
              </svg>
            </div>
            <h2 class="because-item-title">Wide range of brands</h2>
            <div class="because-item-content">
          ...
          <div class="because-item">
            <div class="because-item-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="32" viewBox="0 0 37.001 32">
                <g id="trust" transform="translate(0.001)">
                  <path id="Path_271" data-name="Path 271" d="M243.168,1.072a1.084,1.084,0,0,0-2.168,0V5.665a1.084,1.084,0,0,0,2.168,0Zm0,0" transform="translate(-223.585)" fill="#49df0b"></path>
                  <path id="Path_272" data-name="Path 272" d="M147.238,52.326a1.092,1.092,0,0,0,1.533,0,1.064,1.064,0,0,0,0-1.516l-2.322-2.3a1.092,1.092,0,0,0-1.533,0,1.064,1.064,0,0,0,0,1.516Zm0,0" transform="translate(-134.149 -44.754)" fill="#49df0b"></path>
                  <path id="Path_273" data-name="Path 273" d="M306.35,52.64a1.086,1.086,0,0,0,.766-.314l2.322-2.3a1.064,1.064,0,0,0,0-1.516,1.092,1.092,0,0,0-1.533,0l-2.322,2.3a1.063,1.063,0,0,0,0,1.516,1.087,1.087,0,0,0,.766.314Zm0,0" transform="translate(-283.206 -44.754)" fill="#49df0b"></path>
                  ...
                  <path id="Path_276" data-name="Path 276" d="M25.2,86.982A4.567,4.567,0,1,0,20.634,91.5,4.547,4.547,0,0,0,25.2,86.982Zm0,0" transform="translate(-14.906 -76.571)" fill="#49df0b"></path>
                  <path id="Path_277" data-name="Path 277" d="M378.67,86.982A4.567,4.567,0,1,0,374.1,91.5,4.547,4.547,0,0,0,378.67,86.982Zm0,0" transform="translate(-342.831 -76.571)" fill="#49df0b"></path>
                </g>
              </svg>
            </div>
            <h2 class="because-item-title">Trusted by our clients</h2>
            <div class="because-item-content">
              We can help with your financing plan, we can offer some tips and
              tricks. Drive off with this dream car of yours regardless of your
              credit history.
          ...
          <div class="because-item">
            <div class="because-item-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="32" viewBox="0 0 28 44.654">
            ...
            <h2 class="because-item-title">Fast & easy financing</h2>
            <div class="because-item-content">
              We can help with your financing plan, we can offer some tips and
              tricks. Drive off with this dream car of yours regardless of your
              credit history.
        ...
        <div class="our-team__info">
          <div class="our-team-info__left">
            ...
            <ul class="team-info-list">
              <li class="team-item">Praesent nibh luctus viverra</li>
              <li class="team-item">Adipiscing elit</li>
              <li class="team-item">Tempor incididunt ut labore</li>
              <li class="team-item">Quis ipsum suspendisseviverra</li>
              <li class="team-item">Maecenas ac</li>
            </ul>
            <div class="learn-btn">
              <a href="#" class="vahica-buttom">Learn more</a>
            </div>
            <div class="slideshow">
              <div class="slideshow-left-btn" @click="swiperLeft(1)">
                <i class="far fa-chevron-left"></i>
              </div>
              <div class="slideshow-right-btn" @click="swiperRight(1)">
      ...
      <div class="container">
        <div class="how-to-buy-car-top swiper">
          <div class="swiper-wraper">
            <div class="slideshow-left-btn" @click="swiperLeft(2)">
              <i class="far fa-chevron-left"></i>
            </div>
            <div class="swiper-content">
              <ul class="swiper-list" :style="{ left: imgPosi + 'px' }">
                <li class="swiper-list-item">
                  <a href="#" class="swiper-list-item-link"><img src="~/assets/imgs/themeforest.png" alt="a" /></a>
                </li>
                <li class="swiper-list-item">
                  <a href="#" class="swiper-list-item-link"><img src="~/assets/imgs/themeforest.png" alt="b" /></a>
                </li>
                <li class="swiper-list-item">
                  <a href="#" class="swiper-list-item-link"><img src="~/assets/imgs/themeforest.png" alt="v" /></a>
                </li>
                <li class="swiper-list-item">
                  <a href="#" class="swiper-list-item-link"><img src="~/assets/imgs/themeforest.png" alt="d" /></a>
                </li>
                <li class="swiper-list-item">
                  <a href="#" class="swiper-list-item-link"><img src="~/assets/imgs/themeforest.png" alt="s" /></a>
                </li>
              </ul>
            </div>
            <div class="slideshow-right-btn" @click="swiperRight(2)">
              <i class="far fa-chevron-right"></i>
            </div>
          </div>
        </div>
    ...
    a {
      ...
      .img-inner {
        ...
        background: rgba(0, 0, 0, 0)
          linear-gradient(0deg, rgba(0, 0, 0, 0.6) 8%, rgba(0, 0, 0, 0) 94%)
          repeat scroll 0 0;
        z-index: 2;
        line-height: 25px;
        color: #a7a7a7;
...
.search {
  height: 620px;
  background-color: #222732;
  background-image: url(https://chinaexportcar.com/wp-content/uploads/2020/10/bg-1920-new.jpg);
...
.popular-makes {
  ...
  .popular-makes-tabs {
    ...
    justify-content: space-between;
    padding-bottom: 20px;
    .popular-makes-tab-btns {
      display: flex;
      .popular-makes-tab-btn {
        height: 64px;
        padding: 0 29px;
        margin: 0 6px;
        border-radius: 15px;
        ...
        text-align: center;
        .popular-makes-tab-btn__title {
          font-weight: 600;
        }
        .popular-makes-tab-btn__subtitle {
          font-size: 12px;
...
.why-choose-us {
  ...
  .because-our-info {
    ...
    .because-item {
      ...
      &:nth-child(1) .because-item-icon {
        background-color: #ffece6;
      }
      &:nth-child(2) .because-item-icon {
        background-color: #ecffe6;
      }
      &:nth-child(3) .because-item-icon {
...
.our-team {
  ...
  .our-team__info {
    ...
    &:after {
      ...
      top: 0;
      left: 0;
      background: url(~assets/imgs/background-team.png);
      background-size: cover;
      z-index: -1;
    }
    .our-team-info__left {
